        ...
        {pages.map(page => (
          <li key={page.text}>
            <Link
              ...
              spy={true}
              smooth={true}
              className='block cursor-pointer py-2 pl-3 pr-4 text-white rounded lg:bg-transparent lg:text-white lg:p-0 uppercase hover:text-green-500 hover:transition-all hover:duration-700'
            >
              {page.text}
            </Link>
          </li>
